...
export default function Sidebar() {
  ...
  return (
    <>
      {/* 🪄 Hides the ugly native scrollbar but keeps scroll functionality */}
      <style>{`
      ...
      <div className="sidebar-scroll" style={{
        ...
        paddingTop: '8px', overflowY: 'auto', overflowX: 'hidden' // 🪄 Shifted up & made scrollable
      }}>
        ...
        <button 
          ...
          style={{ 
            ...
            fontWeight: '900', fontSize: '1.2rem', marginBottom: '8px', letterSpacing: '-1px', // 🪄 Reduced margin
            background: 'transparent', border: 'none', cursor: 'pointer',
            color: isDark ? '#ffffff' : '#111111', 
            transition: 'color 0.2s, transform 0.2s', flexShrink: 0
          }}
        ...
        {icons.map(item => {
          ...
          return (
            <button 
              ...
              style={{
                width: '44px', height: '44px', marginBottom: '4px', borderRadius: '8px', border: 'none', cursor: 'pointer', fontSize: '1.2rem', transition: 'all 0.2s', flexShrink: 0, // 🪄 Tighter row height
