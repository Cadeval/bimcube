...
export function compute(inputs) {
    // 1. Read the explicit floor heights
    const { widthX, depthY, h00, h01, h02 } = inputs;
    
    // 2. Calculate CUMULATIVE Absolute Z Elevations
    const zLevels = [
        0,                        // Level 00 (Ground)
        h00,                      // Level 01
        h00 + h01,                // Level 02
        h00 + h01 + h02           // Level 03 (Roof)
    ];
    ...
    return {
        description: `Cumulative Elevations & Layers`,
